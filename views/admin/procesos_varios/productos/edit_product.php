    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="unidad_medida" id="unidad_medida" class="form-control" placeholder="Libras, Kilos, Onzas, Botella, Lata" required="on" autocomplete="off" value="<?php echo $result['unidad_medida'] ?>" />
            </div>
        </div>
